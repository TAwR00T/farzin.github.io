...
export const navLinks: NavLinkItem[] = [
  ...
  { href: "#ai-studio", label: "طراح هوشمند" },
...
export const aiStudioOptions = {
  occasions: ["تولد", "عروسی", "سالگرد", "جشن ویژه", "نامزدی", "رویداد دوستانه"],
  styles: ["کلاسیک و شیک", "مدرن و مینیمال", "هنری و خاص", "لوکس و مجلل", "تیره و دراماتیک"],
  colors: ["طلایی و مشکی", "سفید و طلایی", "قرمز تیره و شکلاتی", "نقره‌ای و خاکستری", "رنگ‌های جواهری"],
};